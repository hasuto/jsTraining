...
document.getElementById('denki').addEventListener('click', function (e) {

    if (document.getElementById("denki").checked) {
...
document.getElementById('setubi').addEventListener('click', function (e) {

    if (document.getElementById("setubi").checked) {
...
document.getElementById('honkan').addEventListener('click', function (e) {

    if (document.getElementById("honkan").checked) {
